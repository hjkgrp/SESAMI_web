...
class BETAn():
    ...
    def saveimgsummary(self, plotting_information, bet_info, betesw_info, data, name ='', sumpath=os.path.join(os.curdir,'imgsummary'),saveindividual = "No", eswminima = None): 
        ...
        if saveindividual=="Yes":
            ...
            self.makeisothermplot(plotting_information, ax,data, maketitle='No', with_fit='Yes', fit_data=[bet_info, betesw_info])
    ...
    def generatesummary(self, data, plotting_information, name='structure', filepath= os.curdir, filename='summary.txt', eswpoints=3,
        ...
        if rbet==(None,None):
            ...
            return None, None # Since SESAMI failed, return None, None to indicate that. Will report an error message to the website.
        else:
